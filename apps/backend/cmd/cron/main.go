...
import (
	...
	"github.com/nrngxv/taskgo/internal/cron"
...
func main() {
	rootCmd := &cobra.Command{
		Use:   "cron",
		Short: "taskgo Cron Job Runner",
		Long:  "taskgo Cron Job Runner - Execute scheduled jobs for the taskgo task management system",
	}
